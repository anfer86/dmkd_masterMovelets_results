...
results.sim.acc <- rbindlist(
  lapply( 1:nfolds,
    function(irun){
      pathdir_irun <- paste0(pathdir, "run", irun, "/Similarity/brightkite/")
      data.frame (
...
results.movelets.acc <- rbindlist(
  lapply( 1:nfolds,
          function(irun){
            pathdir_irun <- paste0(pathdir, "run", irun, "/Movelets/brightkite_movelets/p_false__q_LSP__ms_1__Ms_10/model/")
...
results.masterMovelets.acc <- rbindlist(
  lapply( 1:nfolds,
          function(irun){
            pathdir_irun <- paste0(pathdir, "run", irun, "/MasterMovelets/brightkite_ED/mnf_-1__q_LSP__ms_1__Ms_10/model/")
